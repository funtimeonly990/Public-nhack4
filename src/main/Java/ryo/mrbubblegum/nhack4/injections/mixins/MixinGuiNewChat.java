...
import ryo.mrbubblegum.nhack4.lite.misc.ChatModifier;
...
public class MixinGuiNewChat
    ...
    private int drawStringWithShadow(FontRenderer fontRenderer, String text, float x, float y, int color) {
        if (text.contains("\u00a7+")) {
            ...
            Loader.textManager.drawRainbowString(text, x, y, Color.HSBtoRGB(Colors.INSTANCE.hue, 1.0f, 1.0f), 100.0f, true);
        } else {
