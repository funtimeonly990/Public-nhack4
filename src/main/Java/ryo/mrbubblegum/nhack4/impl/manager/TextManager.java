...
import ryo.mrbubblegum.nhack4.impl.gui.font.CustomFont;
...
public class TextManager
    ...
    public void init(boolean startup) {
        FontMod cFont = Loader.moduleManager.getModuleByClass(FontMod.class);
        try {
    ...
    public float drawString(String text, float x, float y, int color, boolean shadow) {
        if (Loader.moduleManager.isModuleEnabled(FontMod.class)) {
            if (shadow) {
