...
public class TotemPopManager
        ...
        if (this.getTotemPops(player) == 1) {
            if (ModuleTools.getInstance().isEnabled()) {
                switch (ModuleTools.getInstance().popNotifier.getValue()) {
                    ...
                    case NONE: {
                        return Loader.commandManager.getClientMessage() + " " + ChatFormatting.WHITE + player.getName() + " popped " + ChatFormatting.GREEN + this.getTotemPops(player) + ChatFormatting.WHITE + " Totem.";
                    }
                }
            } else {
                return Loader.commandManager.getClientMessage() + " " + ChatFormatting.WHITE + player.getName() + " popped " + ChatFormatting.GREEN + this.getTotemPops(player) + ChatFormatting.WHITE + " Totem.";
            ...
            if (ModuleTools.getInstance().isEnabled()) {
                switch (ModuleTools.getInstance().popNotifier.getValue()) {
                    ...
                    case NONE: {
                        return Loader.commandManager.getClientMessage() + " " + ChatFormatting.WHITE + player.getName() + " popped " + ChatFormatting.GREEN + this.getTotemPops(player) + ChatFormatting.WHITE + " Totems.";
                    }
                }
            } else {
                return Loader.commandManager.getClientMessage() + " " + ChatFormatting.WHITE + player.getName() + " popped " + ChatFormatting.GREEN + this.getTotemPops(player) + ChatFormatting.WHITE + " Totems.";
    ...
    public void init() {
        this.notifications = Loader.moduleManager.getModuleByClass(Notifications.class);
    }
        ...
        if (this.getTotemPops(player) == 1) {
            if (ModuleTools.getInstance().isEnabled()) {
                switch (ModuleTools.getInstance().popNotifier.getValue()) {
                    ...
                    case NONE: {
                        return Loader.commandManager.getClientMessage() + " " + ChatFormatting.WHITE + player.getName() + " died after popping " + ChatFormatting.GREEN + this.getTotemPops(player) + ChatFormatting.WHITE + " Totem!";
            ...
            if (ModuleTools.getInstance().isEnabled()) {
                switch (ModuleTools.getInstance().popNotifier.getValue()) {
                    ...
                    case NONE: {
                        return Loader.commandManager.getClientMessage() + " " + ChatFormatting.WHITE + player.getName() + " died after popping " + ChatFormatting.GREEN + this.getTotemPops(player) + ChatFormatting.WHITE + " Totems!";
