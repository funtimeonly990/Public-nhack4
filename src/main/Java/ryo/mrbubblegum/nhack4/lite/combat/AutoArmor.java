...
public class AutoArmor
    ...
    private final ryo.mrbubblegum.nhack4.impl.util.Timer timer = new Timer();
    ...
    public AutoArmor() {
        super("AutoArmor", "puts and mends armor", Module.Category.COMBAT, true, false, false);
    }
    ...
    public void onTick() {
        ...
        if (this.timer.passedMs((int) ((float) this.delay.getValue().intValue() * Loader.serverManager.getTpsFactor()))) {
            if (!this.taskList.isEmpty()) {
