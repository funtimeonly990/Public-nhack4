...
public class Velocity
    ...
    public void onUpdate() {
        ...
        if (this.entities.getValue().booleanValue()) {
            Util.mc.player.entityCollisionReduction = 1;
        }
    }

    @Override
    public void onEnable() {
        collisionReduction = Util.mc.player.entityCollisionReduction;
    }
    ...
    public void onDisable() {
        ...
        Util.mc.player.entityCollisionReduction = collisionReduction;
    }
