...
public class Feature
    ...
    public TextManager renderer = Loader.textManager;
    private String name;
    ...
    public Setting register(Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof LiteGui) {
            LiteGui.getInstance().updateModule((Module) this);
        }
        return setting;
    }
